        ...
        quote do
            ...
            def init(init_arg) do
                ...
                children = [
                    ...
                    { Registry, registry_args(Aggregate, name) },
                    { Registry, registry_args(Producer, name) },
                    { Registry, registry_args(Channel, name) },
                    { Registry, registry_args(Broker, name) },
                    { Registry, registry_args(Queue, name) },
                    { Registry, registry_args(Saga, name) },
